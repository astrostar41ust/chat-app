...
const LoginPage = () => {
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center gap-8 max-sm:mt-10">
        <img src={assets.favicon} alt="" className="w-[min(30vw,250px)]" />
        <h1 className="text-blue-700 text-5xl text">SunshineChat</h1>
      </div>
      ...
      >
        ...
        <button
          type="submit"
          className="py-3 bg-gradient-to-r from-blue-500 to-blue-700 text-white rounded-md cursor-pointer"
        >
