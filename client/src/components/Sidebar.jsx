      ...
      <div className="pb-5">
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-5">
            <img src={assets.favicon} alt="logo" className="max-w-12" />
            <span>Chat</span>
          </div>
          ...
          <div className="relative py-2 group">
            ...
            bg-blue-900/80 border border-blue-600/50 text-gray-100 hidden group-hover:block"
            >
              <p
        ...
        <div className="bg-blue-900/40 rounded-full flex items-center gap-2 py-3 px-4 mt-5">
        ...
        {filteredUsers.map((user, index) => (
          <div
            ...
            className={`relative flex items-center gap-2 p-2 pl-4 rounded cursor-pointer max-sm-text-sm ${
              selectedUser?._id === user._id && "bg-blue-800/50"
            }`}
          >
            <img
              src={user?.picture || assets.avatar_icon}
              alt=""
