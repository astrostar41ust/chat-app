...
const RightSidebar = () => {
  ...
  // Get all images from the messages and them to the state
  useEffect(() => {
    setMsgImages(
  ...
  return (
    ...
    >
        ...
        <hr className="border-blue-600/50 my-4" />
        ...
        bg-gradient-to-r from-blue-500 to-blue-700 text-white border-none
